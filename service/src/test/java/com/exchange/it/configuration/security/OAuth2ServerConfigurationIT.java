...
/**
 * The type O auth 2 server configuration it.
 */
@Configuration
@EnableAuthorizationServer
class OAuth2ServerConfigurationIT extends AuthorizationServerConfigurerAdapter {
    ...
    /**
     * Instantiates a new O auth 2 server configuration it.
     *
     * @param authenticationManager the authentication manager
     * @param userDetailsService    the user details service
     */
    @Autowired
    public OAuth2ServerConfigurationIT(
